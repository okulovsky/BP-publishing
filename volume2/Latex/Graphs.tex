...
\section{Дополнительные определения теории графов}
...
\uncover<+->{
{\bf Путь (маршрут)} -- это последовательность $v_1,e_1,v_2,e_2,\ldots,v_n$, где $e_i=(v_i,v_{i+1})$, $e_i\in E$, $v_i\in V$.
}\\[0.3cm]
...
\section{Обход лабиринта в ширину}
...
\section{Поиск пути в невзвешенном графе}
